...
<form method='post' action='admin.php?page=editor' id='editor'>
	...
	<fieldset>
		...
		<label>Title</label>
		<input type='text' name='title' maxlength='150' onkeyup='updateEditorMessage()' value='$entryData->title'required/>
		<p id='title-warning'></p>
		<label>Entry</label>
		<textarea name='entry'onkeyup='updateEditorMessage()'>$entryData->entry_text</textarea>
